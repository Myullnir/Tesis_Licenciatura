    ...
    for AGENTES in [1000]:
        ...
        for ALFA in Conjunto_Alfa:
            ...
            for CDELTA in Conjunto_Cdelta:
                ...
                Graficar = np.random.choice(int(len(SuperDiccionario[Carpeta][AGENTES][ALFA][CDELTA])/2),5,False)
                ...
                for nombre in SuperDiccionario[Carpeta][AGENTES][ALFA][CDELTA]:
                    ...
                    if nombre.split("_")[1] == "Opiniones":
                        ...
                        # Levanto los datos de las Opiniones iniciales
                    ...
                    # ----------------------------------------------------------------------------------------------------------------------------
                        ...
                        plt.semilogy(X,Varprom,linewidth=4)
                ...
                plt.grid()
                plt.savefig("../Imagenes/RedAct/{}/Varprom_alfa={:.3f}_Cdelta={:.2f}_N={}.png".format(Carpeta,ALFA,CDELTA,AGENTES),bbox_inches = "tight")
                plt.close("Varprom")
