...
int main(int argc, char *argv[]){
	...
	// Creo mis punteros a structs y los malloqueo.
		...
		char s_archivo1[355];
		sprintf(s_archivo1,"../Programas Python/DilAct/ActividadConexa/Datos_Opiniones_alfa=%.3f_Cdelta=%.2f_N=%d_Iter=%d",ps_datos->f_alfa,ps_datos->f_Cosangulo,ps_datos->i_N,i_iteracion);
