...
int main(int argc, char *argv[]){
	...
	// fprintf(pa_archivo1, "\tMatriz de Adyacencia Conexa\n");
	// Escribir_i(ps_red->pi_Ady,pa_archivo1); // Matriz de Opinión
	...
	fprintf(pa_archivo2, "\tSemilla\n");
	fprintf(pa_archivo2, "\t%ld\n",semilla);
