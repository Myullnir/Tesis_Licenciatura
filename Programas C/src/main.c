...
int main(int argc, char *argv[]){
	...
	// Creo mis punteros a structs y los malloqueo.
		...
		if(strcmp("Barabasi",argv[2])==0) sprintf(s_archivo1,"../Programas Python/DRE/NCC/Barabasi/GM=%d/Datos_Opiniones_alfa=%.2f_Cdelta=%.2f_N=%d_Gm=%d_ID=%d_Iter=%d",ps_datos->i_Gradomedio,ps_datos->f_alfa,ps_datos->f_Cosangulo,ps_datos->i_N,ps_datos->i_Gradomedio,ps_datos->i_ID,i_iteracion);
		if(strcmp("ErdosRenyi",argv[2])==0) sprintf(s_archivo1,"../Programas Python/DRE/NCC/Erdos-Renyi/GM=%d/Datos_Opiniones_alfa=%.2f_Cdelta=%.2f_N=%d_Gm=%d_ID=%d_Iter=%d",ps_datos->i_Gradomedio,ps_datos->f_alfa,ps_datos->f_Cosangulo,ps_datos->i_N,ps_datos->i_Gradomedio,ps_datos->i_ID,i_iteracion);
		if(strcmp("RandomR",argv[2])==0) sprintf(s_archivo1,"../Programas Python/DRE/NCC/RandomRegulars/GM=%d/Datos_Opiniones_alfa=%.2f_Cdelta=%.2f_N=%d_Gm=%d_ID=%d_Iter=%d",ps_datos->i_Gradomedio,ps_datos->f_alfa,ps_datos->f_Cosangulo,ps_datos->i_N,ps_datos->i_Gradomedio,ps_datos->i_ID,i_iteracion);
