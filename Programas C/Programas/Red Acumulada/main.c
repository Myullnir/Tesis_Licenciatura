...
int main(int argc, char *argv[]){
	...
	// Creo mis punteros a structs y los malloqueo.
		...
		int i_renovar_Adyacencia = (int) (1/ps_datos->f_dt)*5; // Este número es la cantidad de veces que itero el sistema antes de renovar la matriz de Adyacencia
		...
		char s_archivo1[355];
		sprintf(s_archivo1,"../Programas Python/DilAct/AcRedes/Datos_Opiniones_alfa=%.3f_Cdelta=%.2f_N=%d_Iter=%d",ps_datos->f_alfa,ps_datos->f_Cosangulo,ps_datos->i_N,i_iteracion);
		...
		char s_archivo2[355];
		sprintf(s_archivo2,"../Programas Python/DilAct/AcRedes/Datos_Testigos_alfa=%.3f_Cdelta=%.2f_N=%d_Iter=%d",ps_datos->f_alfa,ps_datos->f_Cosangulo,ps_datos->i_N,i_iteracion);
